...
fifth_keyboard = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton(text="⬅️ ʙᴀᴄᴋ", callback_data=f"cbmenu"),
        ],
    ]
)
    ...
    [
        [
         ...
         [   InlineKeyboardButton("Medium Quality", callback_data="medium"),
            ...
            InlineKeyboardButton(text="⬅️ ʙᴀᴄᴋ", callback_data=f"cbmenu"),
            InlineKeyboardButton(text="ᴄʟᴏsᴇ 🗑️", callback_data=f"cls"),
        ],
    ]
)
    ...
    [
        [
            ...
            InlineKeyboardButton(text="ᴠᴏʟᴜᴍᴇ", callback_data=f"fifth"),
             InlineKeyboardButton(text="ǫᴜᴀʟɪᴛʏ", callback_data=f"high"),
        ],[
            InlineKeyboardButton(text="ᴄʟᴇᴀɴ-ᴅʙ", callback_data=f"dbconfirm"),
             InlineKeyboardButton(text="ɪɴғᴏ", callback_data=f"nonabout"),
        ],[
             InlineKeyboardButton(text="🗑️ ᴄʟᴏsᴇ ᴍᴇɴᴜ", callback_data=f"cls"),
        ],
    ]
)
