...
from Bobby import BOT_NAME, BOT_USERNAME
from Bobby.calls import calls, queues
from Bobby.calls.youtube import download
from Bobby.calls import convert as cconvert
from Bobby.calls.calls import client as ASS_ACC
from Bobby.core.queue import (
    get_active_chats,
    is_active_chat,
    add_active_chat,
    remove_active_chat,
...
import Bobby.calls
from Bobby.calls import youtube
...
from Bobby.setup.decorators import errors, sudo_users_only
from Bobby.setup.administrator import adminsOnly
from Bobby.setup.errors import DurationLimitError
from Bobby.setup.gets import get_url, get_file_name
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
   ...
   # img_arr =np.array(image3)
    ...
    # fonts
    font1 = ImageFont.truetype(r'etc/Bobby.otf', 30)
    font2 = ImageFont.truetype(r'etc/Bobby.otf', 60)
    font3 = ImageFont.truetype(r'etc/Bobby.otf', 49)
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = audio.title
        thumb_name = "https://telegra.ph/file/1bab5e1b04d56eb02e09f.jpg"
    ...
    [
       ...
       [
            ...
            InlineKeyboardButton("📨 sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/KaoriXSupport"),
        ],[
    ...
    if await is_active_chat(message.chat.id):
        ...
        await message.reply_photo(
            ...
            caption="**[ᴘʟᴀʏɪɴɢ ᴍᴜsɪᴄ ᴠɪᴀ ʏᴏᴜᴛᴜʙᴇ 📡]({})**\n\n• ᴜsᴇʀ : {}\n• ɢʀᴏᴜᴘ : [{}](https://t.me/KaoriXRobot)".format(
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="**[ᴘʟᴀʏɪɴɢ ᴍᴜsɪᴄ ᴠɪᴀ ʏᴏᴜᴛᴜʙᴇ 📡]({})**\n\n• ᴜsᴇʀ : {}\n• ɢʀᴏᴜᴘ : [{}](https://t.me/KaoriXSupport)".format(
                url, message.from_user.mention(), message.chat.title
            ),
        )
